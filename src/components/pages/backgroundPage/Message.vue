...
export default {
  ...
  data() {
    return {
      circleUrl: 'http://localhost:9090/file/4366ab978923413eb9c6e5d7fc9a019f.jpg',
      user: {},
      isCollapse: false,
      users: [],
      chatUser: '',
  ...
  methods: {
    ...
    createContent(remoteUser, nowUser, text) {  // 这个方法是用来将 json的聊天消息数据转换成 html的。
      ...
      if (nowUser) { // nowUser 表示是否显示当前用户发送的聊天消息，绿色气泡
        html = "<div class=\"el-row\" style=\"padding: 5px 0\">\n" +
            ...
            "    <el-avatar    :size=\"40\" :src=\"user.avatarUrl\"></el-avatar> <img :src=\"user.avatarUrl\" style=\"object-fit: cover;\">\n" +
            "  </span>\n" +
            "  </div>\n" +
            "</div>";
        ...
        html = "<div class=\"el-row\" style=\"padding: 5px 0\">\n" +
            ...
            "  <span class=\"el-avatar el-avatar--circle\" style=\"height: 40px; width: 40px; line-height: 40px;\">\n" +
            "    <img src=\"http://localhost:9090/file/4366ab978923413eb9c6e5d7fc9a019f.jpg\" style=\"object-fit: cover;\">\n" +
            "  </span>\n" +
            "  </div>\n" +
    ...
    init() {
      ...
      if (typeof (WebSocket) == "undefined") {
        ...
        console.log("您的浏览器支持WebSocket");
        let socketUrl = "ws://localhost:9090/server/" + username;
        if (socket != null) {
          socket.close();
          socket = null;
        }
