...
<div>
  ...
  <link rel="stylesheet" href="src/assets/NotFind/bootstrap.min.css">

  <link rel="stylesheet" href="src/assets/NotFind/style.css">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <a href="http://localhost:8080/halohome"> <el-button type="success">返回首页</el-button></a>
      </div>
    </div>
  </div>
</div>
...
export default {
  ...
  mounted() {
    ...
    script.src = 'src/assets/NotFind/gsap.min.js';
    document.body.appendChild(script);
    script.type = 'text/javascript';
    script.src = 'src/assets/NotFind/script.js';
    document.body.appendChild(script);
  },
}
